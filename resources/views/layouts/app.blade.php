...
<body>
  ...
  @yield('content')
   ...
   <script src="{{asset('lib/jquery/jquery-migrate.min.js')}}" type="text/javascript"></script>
   <script src="{{asset('lib/bootstrap/js/bootstrap.bundle.min.js')}}" type="text/javascript"></script>
   <script src="{{asset('lib/easing/easing.min.js')}}" type="text/javascript"></script>
   <script src="{{asset('lib/mobile-nav/mobile-nav.js')}}" type="text/javascript"></script>
